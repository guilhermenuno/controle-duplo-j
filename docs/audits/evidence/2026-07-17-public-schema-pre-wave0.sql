...
\restrict zO9MNCwEAAE2AjZNCpbCavZKByfAz9ejNiKoOPvfzQQbvkSKpMGca1OvCV6eS8s
...
--
-- Name: pacientes Usuarios autenticados podem atualizar pacientes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Usuarios autenticados podem atualizar pacientes" ON "public"."pacientes" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);


--
-- Name: pacientes Usuarios autenticados podem inserir pacientes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Usuarios autenticados podem inserir pacientes" ON "public"."pacientes" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: pacientes Usuarios autenticados podem ver pacientes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Usuarios autenticados podem ver pacientes" ON "public"."pacientes" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "audit_insert_approved" ON "public"."patient_audit_log" FOR INSERT WITH CHECK ("public"."is_approved_user"());
...
CREATE POLICY "audit_select_approved" ON "public"."patient_audit_log" FOR SELECT USING ("public"."is_approved_user"());
...
CREATE POLICY "notifications_insert_approved" ON "public"."patient_notifications" FOR INSERT WITH CHECK ("public"."is_approved_user"());
...
CREATE POLICY "notifications_select_admin" ON "public"."patient_notifications" FOR SELECT USING ("public"."is_admin_user"());
...
CREATE POLICY "pacientes_delete_admin_only" ON "public"."pacientes" FOR DELETE USING ("public"."is_admin_user"());
...
CREATE POLICY "pacientes_insert_approved" ON "public"."pacientes" FOR INSERT WITH CHECK (("public"."is_approved_user"() AND ("auth"."uid"() = "cadastrado_por")));
...
CREATE POLICY "pacientes_select_approved" ON "public"."pacientes" FOR SELECT USING ("public"."is_approved_user"());
...
CREATE POLICY "pacientes_update_approved" ON "public"."pacientes" FOR UPDATE USING ("public"."is_approved_user"()) WITH CHECK ("public"."is_approved_user"());
...
CREATE POLICY "profiles_select_self_or_admin" ON "public"."profiles" FOR SELECT USING ((("auth"."uid"() = "id") OR "public"."is_admin_user"()));
...
CREATE POLICY "profiles_update_admin_only" ON "public"."profiles" FOR UPDATE USING ("public"."is_admin_user"()) WITH CHECK ("public"."is_admin_user"());
...
CREATE POLICY "trocas_delete_admin_only" ON "public"."pacientes_troca_programada" FOR DELETE USING ("public"."is_admin_user"());
...
CREATE POLICY "trocas_insert_approved" ON "public"."pacientes_troca_programada" FOR INSERT WITH CHECK (("public"."is_approved_user"() AND ("auth"."uid"() = "created_by")));
...
CREATE POLICY "trocas_select_approved" ON "public"."pacientes_troca_programada" FOR SELECT USING ("public"."is_approved_user"());
...
CREATE POLICY "trocas_update_approved" ON "public"."pacientes_troca_programada" FOR UPDATE USING ("public"."is_approved_user"()) WITH CHECK ("public"."is_approved_user"());
...
\unrestrict zO9MNCwEAAE2AjZNCpbCavZKByfAz9ejNiKoOPvfzQQbvkSKpMGca1OvCV6eS8s
